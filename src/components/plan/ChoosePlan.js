...
import browserblocked1 from '../../assets/images/browser-blocked-1.png';
import browserblocked2 from '../../assets/images/browser-blocked-2.png';
        ...
        axios.get(config.rootLink + '/Plan/Upgrade?id=' + this.props.shop.ID + '&plan=' + this.state.PlanNumber)
            .then(function (response) {
                ...
                if (response.data == '') {
                    ...
                    that.setState({ IsOpenWarning: true });
                }
    ...
    render() {
        return (
            <Card title="Choose the best plan for your business">
                ...
                <Modal
                    open={this.state.IsOpenWarning}
                    onClose={() => { this.setState({ IsOpenWarning: false }) }}
                    title="Cautious: The new tab is getting blocked by the browser"
                    primaryAction={{
                        content: 'Got it',
                        onAction: () => { this.setState({ IsOpenWarning: false }) },
                    }}
                >
                    <Modal.Section>
                        <TextContainer>
                            <p>
                                In case you've activated the charge but your browser is not redirected to the confirm charge page, please check if your browser is blocking opening new tabs or not, please refer to the instruction below.
                            </p>
                            <img src={browserblocked1}></img>
                            <p>Click “Always allow popup-ups" to continue .</p>
                            <img src={browserblocked2}></img>
